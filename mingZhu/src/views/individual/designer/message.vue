  ...
  <div class="messageWrapper">
    <mdb-container>
      <mdb-row>
        ...
        <mdb-col md="10">
            <mdb-tbl>
              <!-- <mdb-tbl-pane class="fade" key="pills1"  > -->
                <mdb-tbl>
                  <mdb-tbl-head>
                    <tr>
                  ...
                  <mdb-tbl-body>
                    <tr  v-for="(item,index) in personalNotify" :key="index">
                      ...
                      <td style="white-space: nowrap;">
                        <span @click="setContact(item)" style="margin-right:0.5rem;" class="view" @click.stop="viewInfo(item.id)"><mdb-icon far icon="eye" /><span>查看</span></span>
                        <span class="delete" @click.stop="deleteInfo(item.id)"><mdb-icon far icon="trash-alt"/><span>删除</span></span>
                      </td>

                      <!-- <td><mdb-btn @click="setContact" size="sm" color="primary">查看</mdb-btn></td> -->
                    </tr>
                  </mdb-tbl-body>
                </mdb-tbl>
    ...
    <layerProblem ref="layPro" :message-notify='messageNotify' :layer-title='layerTitle' :message-type='0'></layerProblem>
  </div>
</template>
