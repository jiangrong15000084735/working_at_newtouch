            ...
            <div class="container-filter row" style="padding: 0 .5rem" >
              <div class="col-lg-2 mb-4" style="padding: 0 0.5rem;">
                <div v-if="index==0" class="filter-header card">
                  ...
                  <!-- <div style="padding-top:1rem;padding-bottom:1rem;  border-bottom: 1px solid #f1f1f1;">
                    <lxx-multiselect labelMode :max-height="32" placeholder="请选择" label-name="name" value-name="id"
                                   :options="buildingTypeList" v-model="bulidTypeChecked"></lxx-multiselect>
                  </div> -->
                  ...
                  <!-- <div style="padding-top:1rem;padding-bottom:1rem;">
                    <lxx-multiselect labelMode :max-height="32" placeholder="请选择" label-name="name" value-name="id"
                                   :options="workplaceList" v-model="workPlaceChecked"></lxx-multiselect>
                  </div> -->
...
export default {
  ...
  watch: {
    ...
    workLifeChecked (v) {
      // if(!v){
      //   this.resourcesForm.workLife = null;
      // }else{
      //   for (let i = 0; i < this.workLifeList.length; i++) {
      //     if (this.workLifeList[i].id === v) {
      //       this.resourcesForm.workLife = [this.workLifeList[i].name]
      //       break
      //     }
      //   }
      // }
    ...
    certificateChecked (v) {
      // if(!v){
      //   this.resourcesForm.certificate = null
      // }else{
      //   for (let i = 0; i < this.qualificationList.length; i++) {
      //     if (this.qualificationList[i].id === v) {
      //       this.resourcesForm.certificate = [this.qualificationList[i].name]
      //       break
      //     }
      //   }
      // }
    ...
    teamChecked (v) {
      // if(!v){
        // this.resourcesForm.team = null
      // }else{
      //   for (let i = 0; i < this.teamNumberList.length; i++) {
      //     if (this.teamNumberList[i].id === v) {
      //       this.resourcesForm.team = [this.teamNumberList[i].name]
      //       break
      //     }
      //   }
      // }
