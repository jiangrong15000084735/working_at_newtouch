...
export function Lensflare() {
  ...
  this.onBeforeRender = function(renderer, scene, camera) {
    ...
    if (validArea.containsPoint(screenPositionPixels)) {
      ...
      var uniforms1 = material1b.uniforms;
      uniforms1.scale.value = scale;
      uniforms1.screenPosition.value = positionScreen;
      ...
      for (var i = 0, l = elements.length; i < l; i++) {
        ...
        var size1 = element.size / viewport.w;
        var invAspect1 = viewport.w / viewport.z;

        uniforms2.scale.value.set(size1 * invAspect1, size1);
