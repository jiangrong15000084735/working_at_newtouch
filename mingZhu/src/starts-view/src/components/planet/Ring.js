...
function Ring(innerRadius, outerRadius, thetaSegments) {
  ...
  for (var i = 0; i < thetaSegments; i++) {
    ...
    this.faces.push(
      new THREE.Face3(vertexIdx + 2, vertexIdx + 1, vertexIdx + 3, normal)
    );
    this.faceVertexUvs[0].push(uvs);
  }
...
Ring.prototype = Object.create(THREE.Geometry.prototype);
